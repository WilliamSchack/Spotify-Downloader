...
if(WIN32)
	if(IS_ARM_CPU)
		set(YTDLP_URL "${YTDLP_URL}_arm64.exe")
		set(YTDLP_FILE_NAME "${YTDLP_FILE_NAME}_arm64.exe")
	else()
...
elseif(UNIX)
	if(IS_ARM_CPU)
		set(YTDLP_URL "${YTDLP_URL}_aarch64_linux")
		set(YTDLP_FILE_NAME "${YTDLP_FILE_NAME}_aarch64_linux")
	else()
