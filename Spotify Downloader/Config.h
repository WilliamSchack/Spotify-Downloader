...
class Config {
    public:
        ...
        static const int NOTICES_SCREEN_INDEX = 4;
        ...
        static inline const QString NOTICES_ICON_FILLED_WHITE = ":/SpotifyDownloader/Icons/Notices_Icon_W_Filled.png";
